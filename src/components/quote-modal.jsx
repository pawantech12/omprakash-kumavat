...
export default function QuoteModal({ children }) {
  ...
  const handleServiceToggle = (serviceId) => {
    ...
    calculateEstimate(updatedServices);
  };

  const calculateEstimate = (selectedServices) => {
    const area = Number.parseInt(formData.area) || 0;
    let total = 0;
    ...
    selectedServices.forEach((serviceId) => {
      ...
      if (service) {
        if (serviceId === "plumbing" || serviceId === "electrical") {
          // For plumbing and electrical, estimate based on area (rough calculation)
    ...
    if (formData.projectType === "commercial") total *= 1.3;
    if (formData.urgency === "urgent") total *= 1.2;
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        >
          ...
          <div className="space-y-6 mt-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            calculateEstimate(formData.services);
                          }}
                        ...
                        <div className="flex items-center space-x-2 pt-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              handleInputChange("visitRequired", checked)
                            }
                          />
                        ...
                        <div className="border-t pt-4">
                          ...
                          <p className="text-sm text-gray-600 mt-2">
                            * This is a rough estimate. Final quote may vary
                            based on site inspection and specific requirements.
                          </p>
                        </div>
                      </CardContent>
                    </Card>
            ...
            >
              {/* existing buttons with whileHover and whileTap */}
              <motion.div
